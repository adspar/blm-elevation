---
title: 'Data Cleaning - Emotions of Coalitional Conflict: Elevation and Anger in response
...
The chronological labels for each study in our data repository do not correspond to the labels used in our main text reporting.

| Repository Label for Study | Manuscript Name of Study |
|----------------------------|--------------------------|
| Study 1                    | Pilot                    |
| Study 2                    | Study 1                  |
| Study 3                    | Study 2                  |
...
Each study has a high level "\_prepare-data.R" script that runs several subscripts for each study, then recodes several variables, generating useful objects for reporting purposes.
